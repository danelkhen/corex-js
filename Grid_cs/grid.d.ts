/// <reference path="../corex-js/sk.d.ts" />
/// <reference path="../corex-jquery/typings/jquery/jquery.d.ts" />
declare namespace corexjs.ui.grid {
    export interface GridCol {
        ...
        Class?: string;
        Width?: number;
        RenderCell?: JsAction3<GridCol, Object, JQuery>;
        RenderHeaderCell?: JsAction2<GridCol, JQuery>;
    }

    export interface GridCol1<T> extends GridCol {
        Prop?: JsFunc1<T, any>;
    ...
    export interface GridCol2<T, V> extends GridCol1<T> {
        Prop?: JsFunc1<T, V>;
        Getter?: JsFunc1<T, V>;
...
interface JQuery {
    Grid<T>(opts: corexjs.ui.grid.GridOptions<T>): JQuery;
}

...
class jQueryHelper {
    ...
    static getOrAppendChildBySelector(parentEl, selector, options) {
        ...
        if (index < total) {
            ...
            while (index < total) {
                ...
                let child = create ? create(dataItem, index) : jQueryHelper.createElementFromSelectorNode(selectorNode);
                var childEl = child[0];
